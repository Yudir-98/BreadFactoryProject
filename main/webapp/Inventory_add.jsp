...
<body>
  <div class="fullScreen">
    <div class="MainContent">
      ...
      <div class="content">
      <form id="form_information" action="./Inventory_add_form.jsp" method="POST">
        재 료&nbsp;&nbsp;&nbsp;: <input type="text" name="material" placeholder="재료를 입력해주세요." required>
        <br>
        수 량&nbsp;&nbsp;&nbsp;: <input type="text" name="amount" placeholder="수량을 입력해주세요." required>
        <br>
        단 위&nbsp;&nbsp;&nbsp;: <input type="text" name="unit" placeholder="단위를 입력해주세요." required>
        </form>
        <div class="buttons">
