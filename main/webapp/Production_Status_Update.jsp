...
<%
	...
	String expected_production = "";
	String expected_consumption = "";
%>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>생산기획 수정페이지</title>
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.6.0/css/all.min.css" integrity="sha512-Kc323vGBEqzTmouAECnVceyQqyqdsSiqLQISBL29aUW4U/M7pSPA/gEUZQqv1cwx4OnYxTxve5UMg5GT6L4JJg==" crossorigin="anonymous" referrerpolicy="no-referrer" />
  <link rel="stylesheet" href="./css/Production_Status_Update.css">
</head>
<body>
...
<%
		...
		try{
			...
			ResultSet rs = pstmt.executeQuery();
			rs.next();
			expected_production = rs.getString("expected_production");
			expected_consumption = rs.getString("expected_consumption");
...
%>   
        ...
        <br>
        예상 판매량 : <input type="text" value="<%= expected_consumption %>" name="expected_consumption" required>
        </form>
        <div class="buttons">
