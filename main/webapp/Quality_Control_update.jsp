...
<%
	...
	String emp_id = "";
	String update_form_link = "./Quality_Control_update_form.jsp?user_id=" + user_id;
...
<%
	...
	Integer defective = null;
	Date reporting_date = null;
...
<% 
		...
		sql = "SELECT b.product_name, a.production, a.consumption, a.defective, a.reporting_date " +
			  "FROM HISTORY a, PRODUCTS b " + 
			  "WHERE a.product_id = b.product_id " +
			  "AND product_hist_num = ?";
		try{
			PreparedStatement pstmt = conn.prepareStatement(sql);
			pstmt.setInt(1, hist_num);
			...
			reporting_date = rs.getDate("reporting_date");
